...
class _RankPageState extends State<RankPage> with SingleTickerProviderStateMixin {
  ...
  int calculatePoints({
    ...
    final workoutPoints = totalWorkouts * 50;
    final likesPoints = totalLikes * 10;
    return weightPoints + workoutPoints + likesPoints;
  }
  ...
  List<RankUser> sortUsers(List<RankUser> users, int category) {
    ...
    switch (category) {
      ...
      case 2: sorted.sort((a, b) => b.totalWorkouts.compareTo(a.totalWorkouts)); break;
        ...
        child: Row(
          children: [
            ...
            CircleAvatar(
              ...
              child: Text(
                rankUser.username.isNotEmpty ? rankUser.username[0].toUpperCase() : '?',
                style: TextStyle(
                  color: divisionColor,
                  fontWeight: FontWeight.bold,
                ),
                ...
                Text(
                  _selectedCategory == 0
                      ...
                      : _selectedCategory == 1
                          ...
                          : _selectedCategory == 2
                              ? '${rankUser.totalWorkouts} treinos'
