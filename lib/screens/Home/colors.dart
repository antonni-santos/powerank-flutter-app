...
class AppColor{
  ...
  static Color homePageTextBig=const Color(0xFFffffff);
  ...
  static Color secondPageContainerGradient1stColor=const Color.fromARGB(255, 41, 75, 179);
  static Color secondPageContainerGradient2stColor=const Color.fromARGB(255, 88, 128, 248);
  static Color secondPageIconsColor=const Color(0xFFfafafe);
